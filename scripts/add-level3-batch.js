...
const definitions = {
  ...
  abnormal: "not usual or typical",
  abroad: "in or to another country",
  accede: "to agree to a request or take office",
  accessible: "easy to reach or use",
  accommodate: "to provide room for or adjust to",
  accord: "agreement or harmony",
  accumulate: "to collect gradually",
  acquired: "gained through effort or experience",
  adapt: "to change for new conditions",
  adaptable: "able to fit new conditions",
  addicted: "unable to stop using or doing something",
  adequate: "good enough for a purpose",
  adhere: "to stick firmly or follow closely",
  adjacent: "next to or nearby",
  advantageous: "helpful or favorable",
  advocate: "to publicly support or a supporter",
  affirm: "to state firmly as true",
  aggregate: "to combine into a total",
  agitation: "public unrest or emotional disturbance",
  alias: "a false or additional name",
  alien: "foreign or unfamiliar",
  ally: "a partner who gives support",
